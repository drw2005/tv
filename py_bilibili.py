...
class Spider(Spider):
    ...
    def ysContent(self, array):
        ...
        seasonPu = []
        if seasons:
            seasonPf.append('更多系列')
            seasonPu.append('更多系列在快速搜索中查看$ ')
        PreviewPf = []
        if PreviewPu:
            PreviewPf.append('预告')
        ...
        fromL = FirstPf + ParsePf + PreviewPf + seasonPf + self.detailContent_args.get('SectionPf', [])
        urlL = FirstPu + ParsePu + PreviewPu + seasonPu + self.detailContent_args.get('SectionPu', [])
