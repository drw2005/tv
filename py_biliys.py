...
class Spider(Spider):
    ...
    def homeVideoContent(self):
        result = {}
        videos = self.get_rank2(tid=4, pg=1)['list'][0:5]
    ...
    def detailContent(self, array):
        ...
        if 'seasons' in jo:
            for season in jo['seasons']:
                ...
                if season_id == id:
                    vod['vod_play_from'] = vod['vod_play_from'].replace(s_title, season_title)
                    continue
                ...
                for tmpJo in episode:
                    ...
                    part += tmpJo['long_title'].replace("#", "-")
                    playUrl += '{0}${1}_{2}#'.format(part, aid, cid)
                vod['vod_play_from'] += '$$$' + season_title
                vod['vod_play_url'] += '$$$' + playUrl
